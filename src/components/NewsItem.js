...
export class NewsItem extends Component {
  ...
  render() {
    ...
    return (
            <div className='my-3'>
                <div className="card" >
                      <img className="card-img-top" src={imageUrl?imageUrl:"https://telanganatoday.com/wp-content/uploads/2022/03/iPhone-14-Pro-to-feature-larger-camera-bump-due-to-new-48MP-sensor.jpg"} alt=""/>
